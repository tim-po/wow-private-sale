...
const LoadingScreen = (props: LoadingScreenPropType) => {
    const {isLoading, header} = props

    return (
      <div
        className={`loadingModal ${isLoading ? 'visible': ''}`}
      >
          <div className="loadingModalContent">
              <h1 className="loadingModalHeader">{header}</h1>
              <div className="loadingModalLoader">
                  <svg className={'loader'} width="64" height="64" viewBox="0 0 64 64" fill="none" xmlns="http://www.w3.org/2000/svg">
                      <path
