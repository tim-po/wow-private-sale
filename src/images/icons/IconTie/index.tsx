...
const IconTie = () => {
  return (
    ...
    >
      <path
        className={'tieBody'}
        d="M6.08104 4.52271C6.16224 4.0795 6.5485 3.75758 6.99909 3.75758H8.99909C9.4496 3.75758 9.83581 4.07938 9.9171 4.5225L11.2273 11.6646C11.2921 12.0177 11.1486 12.3768 10.8582 12.5879L8.54802 14.2675C8.22071 14.5055 7.77734 14.5054 7.4501 14.2673L5.14147 12.5878C4.85126 12.3767 4.70781 12.0179 4.77248 11.6649L6.08104 4.52271Z"
      />
